...
module.exports = {
  ...
  execute: async (interaction) => {
    ...
    const bakimmodu = new EmbedBuilder()
      ...
      .setDescription(`Herhangi bir sorunuz vs. varsa <@710080675298148492>'e ulaşınız!`);

    if (db.fetch(`bakim`)) {
      if (interaction.user.id !== "710080675298148492") { return interaction.reply({ embeds: [bakimmodu] }) }
    }
